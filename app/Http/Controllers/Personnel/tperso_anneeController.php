...
class tperso_anneeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (!is_null($request->get('query'))) {
            ...
            $data = DB::table('tperso_annee')->select("tperso_annee.id","tperso_annee.name_annee",
            "active","tperso_annee.created_at")
           ...
           return response($data, 200);
            ...
            ->select("tperso_annee.id","tperso_annee.name_annee","active","tperso_annee.created_at")
    ...
    function fetch_annee_encours()
    {
        $data = DB::table('tperso_annee')
        ->select("tperso_annee.id","tperso_annee.name_annee","active","tperso_annee.created_at")
        ->where('tperso_annee.active', 'OUI')
        ->orderBy("id", "desc")->get();
        return response()->json([
            'data'  => $data,
        ]);
