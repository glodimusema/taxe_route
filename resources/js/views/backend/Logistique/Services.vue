<template>
  ...
  export default {
    ...
    methods: {
      ...
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_log_service?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_log_service`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_log_service/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_log_service/${id}`).then(
            ({ data }) => {
