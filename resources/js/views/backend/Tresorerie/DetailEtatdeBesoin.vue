...
//
      var tables='tt_treso_detail_etatbesoin';
      var user_name=this.userData.name;
      var user_id=this.userData.id;
      var detail_information="Suppression d'une detail : "+noms+" sur le l'etat de besoin n° "+numEntete+" par l'utilisateur "+user_name+"" ;
