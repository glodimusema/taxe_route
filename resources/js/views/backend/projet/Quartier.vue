<template>
                ...
                <v-card-text>
                    ...
                    <v-layout row wrap>
                        ...
                        <v-flex xs12 sm12 md12 lg12>
                           ...
                           <div class="mr-1">
                                <v-text-field
                                    label="Code de quartier"
                                    prepend-inner-icon="extension"
                                    :rules="[(v) => !!v || 'Ce champ est requis']"
                                    outlined
                                    dense
                                    v-model="svData.codeQuartier"
                                ></v-text-field>
                           </div>
                ...
                <template v-slot:default>
                  <thead>
                    <tr>
                      ...
                      <th class="text-left">Code de quartier</th>
  ...
  export default {
    ...
    methods: {
      ...
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_quartier?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_quartier`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_quartier/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_quartier/${id}`).then(
            ({ data }) => {
