<template>
  ...
  export default {
    ...
    methods: {
      ...
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_ville?page=`);
      },
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_ville/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_ville/${id}`).then(
            ({ data }) => {
