<template>
  ...
  export default {
    ...
    methods: {
      ...
      ,
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_all_annee_stage?page=`);
      },
      ...
      validate() {
        if (this.$refs.form.validate()) {
          ...
          this.insertOrUpdate(
            `${this.apiBaseURL}/insert_annee_stage`,
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_annee_stage/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_annee_stage/${id}`).then(
            ({ data }) => {
