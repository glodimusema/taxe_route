                  ...
                  <v-dialog v-model="dialog" max-width="900px" persistent>
                    <v-card :loading="loading">
                      <v-form ref="form" lazy-validation>
                        <v-card-title>
                          Importation des presences <v-spacer></v-spacer>
                      ...
                      <v-layout>
                        ...
                        <v-flex md1>
                          <v-tooltip bottom color="black">
                            ...
                            <span>Importer les Presences</span>
                          </v-tooltip>
                        </v-flex>
                      </v-layout>
                      <br />
    ...
    methods: {
      ...
      updatePhoto() {
        ...
        if (this.edit == true) {
          ...
          axios
            .post(`${this.apiBaseURL}/import_presence_excel`, formData, config)
            .then(({ data }) => {
              this.image = "";
      ...
      fetchDataList() {
        this.fetch_data(`${this.apiBaseURL}/fetch_all_perso_presences_agent?page=`);
        //
      }
