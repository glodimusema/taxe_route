  ...
  methods: {
    ...
    testTitle() {
      if (this.edit == true) {
        ...
        this.titleComponent = "Ajout Taxe";
      }
    }
    ,
    onPageChange() {
      this.fetch_data(`${this.apiBaseURL}/fetch_all_taxe_poste_affect?page=`);
    },
    ...
    validate() {
      if (this.$refs.form.validate()) {
        ...
        this.insertOrUpdate(
          `${this.apiBaseURL}/insert_taxe_poste_affect`,
    ...
    editData(id) {
      this.editOrFetch(`${this.apiBaseURL}/fetch_single_taxe_poste_affect/${id}`).then(
        ({ data }) => {
    ...
    clearP(id) {
      this.confirmMsg().then(({ res }) => {
        this.delGlobal(`${this.apiBaseURL}/delete_taxe_poste_affect/${id}`).then(
          ({ data }) => {
