                    ...
                    <v-form ref="form" lazy-validation>
                      ...
                      <v-card-text>
                        <v-layout row wrap>
                          ...
                          <v-flex xs12 sm12 md6 lg6>
                            <div class="mr-1">
                              <v-autocomplete label="Selectionnez le Sous Poste"
                                  ...
                                  @change="fetchListSelectionSite()">
                              </v-autocomplete> 
                            </div>
                          </v-flex>
                          <v-flex xs12 sm12 md6 lg6>
                            <div class="mr-1">
                                <v-autocomplete label="Selectionnez le Site d'Affectation"
                                  prepend-inner-icon="mdi-map" :rules="[(v) => !!v || 'Ce champ est requis']"
                                  :items="sitesList" item-text="nom_site_affect" item-value="id" dense
                                  outlined v-model="svData.refSiteAffectation" chips clearable
                                  >
                              </v-autocomplete>                           
                            </div>
                          </v-flex>
                          ...
                          <!-- nomOffice  postnomOffice  qualifieOffice-->
                          <v-flex xs12 sm12 md12 lg12>
                            <div class="mr-1">
                              ...
                              <tr v-for="item in fetchData" :key="item.id">
                                ...
                                <td>
                                  <v-btn elevation="2" x-small class="white--text"
                                    ...
                                    depressed>
                                    {{ item.dureerestante > 0 ? 'Encours' : item.dureerestante <= 0 ? 'Fin Contrat'
                                      :'error' }} </v-btn>
                                </td>
...
export default {
  ...
  methods: {
    ...
    fetchListSelectionSite() {
       this.editOrFetch(`${this.apiBaseURL}/fetch_single_taxe_site_by_sousposte/${this.svData.id_sous_poste_affect}`).then(
         ({ data }) => {
             var donnees = data.data;
             this.sitesList = donnees;
         }
       );
    }
