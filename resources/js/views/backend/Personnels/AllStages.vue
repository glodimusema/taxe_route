...
<div>
          ...
          <v-form ref="form" lazy-validation>
            ...
            <v-card-text>
              <v-layout row wrap>
                ...
                <v-flex xs12 sm12 md12 lg12>
                  <div class="mr-1">
                    <v-autocomplete label="Selectionnez l'Année académique" prepend-inner-icon="mdi-map"
                ...
                <template v-slot:default>
                  ...
                  <tbody>
                    <tr v-for="item in fetchData" :key="item.id">
                      ...
                      <td>{{ item.date_debut_stage }}</td>
                      <td>{{ item.date_fin_stage }}</td>
                      <td>
                          <v-btn
                              elevation="2"
                              x-small
  ...
  export default {
    ...
    methods: {
      ...
      fetchDataList() {
        this.fetch_data(`${this.apiBaseURL}/fetch_all_perso_stages?page=`);
      },
