<template>
  ...
  export default {
    ...
    methods: {
      ...
      showModal() {
        this.dialog = true;
        this.titleComponent = "Paramètrage Avantage de l'entreprise ";
        this.edit = false;
      ...
      testTitle() {
        if (this.edit == true) {
          this.titleComponent = "modification d'avantage de l'entreprise ";
      ...
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_avantage?page=`);
      },
      ...
      updatePhoto() {
        ...
        if (this.edit == true) {
          axios
            .post(`${this.apiBaseURL}/update_avantage`, formData, config)
            .then(({ data }) => {
              this.image = "";
          ...
          axios
            .post(`${this.apiBaseURL}/insert_avantage`, formData, config)
            .then(({ data }) => {
              this.image = "";
              this.showMsg(data.data);
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_avantage/${id}`).then(
          ({ data }) => {
            var donnees = data.data;
  
            donnees.map((item) => {
              this.svData.id = item.id;
              this.titleComponent = "modification de Decision de l'entreprise ";
            });
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_avantage/${id}`).then(
            ({ data }) => {
