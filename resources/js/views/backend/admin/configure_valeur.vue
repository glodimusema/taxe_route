<template>
  ...
  export default {
    ...
    methods: {
      ...
      showModal() {
        this.dialog = true;
        this.titleComponent = "Paramètrage Valeur ";
        this.edit = false;
      ...
      testTitle() {
        if (this.edit == true) {
          this.titleComponent = "modification de Valeur ";
      ...
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_valeur?page=`);
      },
      ...
      updatePhoto() {
        ...
        if (this.edit == true) {
          axios
            .post(`${this.apiBaseURL}/update_valeur`, formData, config)
            .then(({ data }) => {
              this.image = "";
          ...
          axios
            .post(`${this.apiBaseURL}/insert_valeur`, formData, config)
            .then(({ data }) => {
              this.image = "";
              this.showMsg(data.data);
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_valeur/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_valeur/${id}`).then(
            ({ data }) => {
