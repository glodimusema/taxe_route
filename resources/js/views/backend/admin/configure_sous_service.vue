<template>
                    ...
                    <v-flex xs12 md12 sm12 lg12>
                       ...
                       <v-flex xs12 md12 sm12 lg12>
                          ...
                          <v-select
                            ...
                            :items="AllservicesArticleList"
                            item-text="nom"
                            item-value="id"
                            outlined
                            v-model="svData.id_service"
                            >
                           </v-select>
                      </v-flex>
                  ...
                  <template v-slot:default>
                    ...
                    <tbody>
                      <tr v-for="item in fetchData" :key="item.id">
                        ...
                        <td>{{ item.service | subStrLong2 }}</td>
  ...
  export default {
    ...
    computed: {
      ...mapGetters(["basicList","AllservicesArticleList", "isloading"]),
    },
    methods: {
      ...mapActions(["getBasic", "getAllServices"]),
  
     
      showModal() {
        this.dialog = true;
        this.titleComponent = "Paramètrage sous services de l'entreprise ";
        this.edit = false;
      ...
      testTitle() {
        if (this.edit == true) {
          this.titleComponent = "modification de sous services de l'entreprise ";
      ...
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_sous_service?page=`);
      },
      ...
      updatePhoto() {
        ...
        if (this.edit == true) {
          axios
            .post(`${this.apiBaseURL}/update_sous_service`, formData, config)
            .then(({ data }) => {
              this.image = "";
          ...
          axios
            .post(`${this.apiBaseURL}/insert_sous_service`, formData, config)
            .then(({ data }) => {
              this.image = "";
              this.showMsg(data.data);
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_sous_service/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_sous_service/${id}`).then(
            ({ data }) => {
