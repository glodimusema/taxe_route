<template>
  ...
  export default {
    ...
    methods: {
      ...
      showModal() {
        this.dialog = true;
        this.titleComponent = "Paramètrage Choix de l'entreprise ";
        this.edit = false;
      ...
      onPageChange() {
        this.fetch_data(`${this.apiBaseURL}/fetch_choix?page=`);
      },
      ...
      updatePhoto() {
        ...
        if (this.edit == true) {
          axios
            .post(`${this.apiBaseURL}/update_choix`, formData, config)
            .then(({ data }) => {
              this.image = "";
          ...
          axios
            .post(`${this.apiBaseURL}/insert_choix`, formData, config)
            .then(({ data }) => {
              this.image = "";
              this.showMsg(data.data);
      ...
      editData(id) {
        this.editOrFetch(`${this.apiBaseURL}/fetch_single_choix/${id}`).then(
          ({ data }) => {
      ...
      clearP(id) {
        this.confirmMsg().then(({ res }) => {
          this.delGlobal(`${this.apiBaseURL}/delete_choix/${id}`).then(
            ({ data }) => {
