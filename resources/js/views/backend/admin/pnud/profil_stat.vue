        ...
        <v-layout
            ...
            <v-flex md3 lg3 xs12 class="mb-2">
                ...
                >
                    ...
                    <v-list-item three-line router to="/user/liste_entreprise"> 
                    <v-list-item-content>
                        <div class="text-overline mb-4">Mes Projets Jinnov</div>
            ...
            <v-flex md3 lg3 xs12 class="mb-2">
                ...
                >
                    ...
                    <v-list-item-content>
                        <div class="text-overline mb-4">Projets inactifs</div>
                        <v-list-item-title class="text-h5 mb-1">
                         {{svData.projetInactif}} 
                        </v-list-item-title>
            ...
            <v-flex md3 lg3 xs12 class="mb-2">
                ...
                >
                    ...
                    <v-list-item-content>
                        <div class="text-overline mb-4">Projets actifs</div>
                        <v-list-item-title class="text-h5 mb-1">
                         {{svData.projetActif}}  
                        </v-list-item-title>
                        <v-list-item-subtitle
...
export default {
    ...
    methods: {
        ...
        showCountNotification() {
            ...
            this.editOrFetch(
                `${this.apiBaseURL}/showCountDashbord_tug/${id_user}`
            ).then(({ data }) => {
