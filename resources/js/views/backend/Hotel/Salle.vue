                    ...
                    <v-card :loading="loading">
                        <v-form ref="form" lazy-validation>
                            ...
                            <v-card-text>
                                ...
                                <v-text-field label="Prix de la Salle" prepend-inner-icon="extension"
                                    :rules="[(v) => !!v || 'Ce champ est requis']" outlined
                                    v-model="svData.prix_salle"></v-text-field>
...
export default {
    ...
    methods: {
        ...
        //   }, 300),
        onPageChange() {
            this.fetch_data(`${this.apiBaseURL}/fetch_hotel_salle?page=`);
        },
        ...
        validate() {
            if (this.$refs.form.validate()) {
                ...
                this.insertOrUpdate(
                    `${this.apiBaseURL}/insert_hotel_salle`,
        ...
        clearP(id) {
            this.confirmMsg().then(({ res }) => {
                this.delGlobal(`${this.apiBaseURL}/delete_hotel_salle/${id}`).then(
                    ({ data }) => {
